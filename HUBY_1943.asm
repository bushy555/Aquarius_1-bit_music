...
;
;
; Load the .BIN in as a cartridge ROM file. Reboot. 
; And the tune from the ZX spectrum "1943" game should play through the internal speakers.
; 710 bytes in length.
;
...
;	db     55,66,73,84,77,156,73,176               ; Scramble code for start of cartridge
;	db     76,108,76,100,73,168,147,112            ; "8BITMILLI" with no extra byte


        db     	56	;8               ; Scramble code for start of cartridge
	db	66	;B
	db	73	;I
	db	84	;T
	db	77	;
	...
	db	168	;
	db	147	;
	db	112     ; "8BITMILLI" with no extra byte
