;==================================================================
;
;   ENGINE: OctodeXL by shiru & introspec
;   SONG  : (X2) NIGHT DANCER.  MISTER BEEP.
;   PORTED: to the Aquarius by Dave. Nov'24.
;
;==================================================================
;
...
; generation is now using a crude variant of PWM.
	...
	output "dancer.caq"		; Assembler: SJASM

; ------------------------------------------------------------------
;
; BASIC HEADER for Aquarius.
; Adds the below BASIC startup listing to call the M/L. 
; Once loaded into your Aquarius/Emulator, don't edit it. Will crash!
;
;----
; TO use:
;	CLOAD  (then press <ENTER> and play the .CAQ file)
;----
;
;	10 REM  NIGHT DANCER by Mister Beep.      Ported by Dave.
;	20 B=0
;	30 POKE 14340,088:POKE 14341,057
;	40 B=USR(0):END
;
	.org $38E1
	.byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
	.byte $00
	.byte "dancer"					; cassette tape file name, displays on screen during CLOADing, 6 characters.
	.byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
; ORG $3900
	.byte $00					
	.byte $25,$39,$0a,$00				; line link, line number
	.byte $8e					; REM
;	.byte " for Aquarius S2 (do not edit)"
	.byte " NIGHT DANCER by Mister Beep.      Ported by Dave."
	.byte 00
	.byte $2d, $39, $14, $00			; line link, line number
	.byte $42, $B0, $30, $3A			; B=0:
	.byte $94, $20, "14340", $2C, "088"		; poke 14340,nnn:poke 14341,mmm
	.byte $3A
	.byte $94, $20, "14341", $2C, "057"
	.byte 00
	.byte (MLEND & 255)				; line link, line number
	.byte (MLEND >> 8)
	.byte $28, $00
	.byte $42, $B0,$B5,$28,$30,$29,$3A,$80		; B=USR(0):END
	.byte $00
	.byte $00,$00
...
begin:		ld	hl, musicdata
		call	play
		ld	hl, (end0)	; funny test to identify sna
		ld	de, 65536-#C0DE
		add	hl, de
		ld	a, h
		or	l
...
.noiseLoop:	ld a,c 
	...
	out 	($fc),a					; Aquarius	11
; 	out 	(254),a					; ZX Spectrum	11
;	ld	($6800),a 				; VZ		13
;	xor	64					; MICROBEE	4?
;	out	(2), a					; microbee	11
