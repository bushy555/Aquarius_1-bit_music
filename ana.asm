...
;---------------
	...
	aquarius_soundbit_high 	equ	1; 255	;01
...
;	ld   	a, zx_soundbit_high 
;	ld   	a, vz_soundbit_high 
;	ld   	a, microbee_soundbit_high 
...
;	xor   	zx_soundbit_high 
;	xor  	vz_soundbit_high 
;	xor  	microbee_soundbit_high 
