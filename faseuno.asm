...
;Assembled to $e000 with SJASMPLUS
;
;
;Load in Binary file : "faseuno.bin"
;at memory $E000
...
;	ld de,$0100				; Aquarius	Speaker on bit 1
;	ld de,$1000				; ZX		Speaker on bit 4
;	ld de,$2100				; VZ		Speaker on bit 1 and 5
;	ld de,$4000				; MICROBEE	Speaker on bit 6
